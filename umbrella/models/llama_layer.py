...
class LlamaLayer:
    ...
    def copy(self, layer: LlamaLayer):
    ...
    def alloc_space(self, layer: LlamaLayer, device):
...
class LlamaPackedLayer:
    ...
    def copy(self, layer: LlamaPackedLayer):
    ...
    def alloc_space(self, layer: LlamaPackedLayer, device):
...
class LlamaAwqLayer():
    ...
    def alloc_space(self, layer: LlamaAwqLayer, device):
    ...
    def copy(self, layer: LlamaAwqLayer):
