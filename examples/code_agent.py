...
logger = setup_logger()
import torch
from umbrella.templates import Prompts, SysPrompts, ExtraPrompts
...
parser.add_argument('--template', type=str, default="llama3-code",help='prompt template')
parser.add_argument('--G', type=int, default=1024, help='generation length')
...
extra_prompt = ExtraPrompts[template]
user_prompt = Prompts[template]
system_prompt = system_prompt.format(extra_prompt)
text = "Write a python file to draw a christmas tree only using print() function. Users can specify the height and width."
